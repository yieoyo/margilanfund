                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class=" row">
                                <div class="col-md-2 col-sm-4 col-6"><span class="data-attr"
                                        data-peity='{ "fill": ["rgb(192, 10, 39)", "rgba(192, 10, 39, .5)"],    "innerRadius": 10, "radius": 40 }'>1/7</span>
                                </div>
                                <div class="col-md-2 col-sm-4 col-6 mt-3 mt-md-0"><span class="data-attr"
                                        data-peity='{ "fill": ["rgb(0, 0, 128)", "rgba(0, 0, 128, .5)"], "innerRadius": 14, "radius": 36 }'>2/7</span>
                                </div>
                                <div class="col-md-2 col-sm-4 col-6 mt-3 mt-md-0"><span class="data-attr"
                                        data-peity='{ "fill": ["rgb(0, 171, 197)", "rgba(0, 171, 197, .5)"], "innerRadius": 16, "radius": 32 }'>3/7</span>
                                </div>
                                <div class="col-md-2 col-sm-4 col-6 mt-3 mt-md-0"><span class="data-attr"
                                        data-peity='{ "fill": ["rgb(206, 29, 118)", "rgba(206, 29, 118, .5)"],  "innerRadius": 18, "radius": 28 }'>4/7</span>
                                </div>
                                <div class="col-md-2 col-sm-4 col-6 mt-3 mt-md-0"><span class="data-attr"
                                        data-peity='{ "fill": ["rgb(7, 135, 234)", "rgba(7, 135, 234, .5)"],   "innerRadius": 20, "radius": 24 }'>5/7</span>
                                </div>
                                <div class="col-md-2 col-sm-4 col-6 mt-3 mt-md-0"><span class="data-attr"
                                        data-peity='{ "fill": ["#f21780", "rgba(242, 23, 128, .1)"], "innerRadius": 18, "radius": 20 }'>6/7</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                            ...
                            <div class=""><span class="donut"
                                    data-peity='{ "fill": ["rgb(117, 180, 50)", "rgba(117, 180, 50, .5)"]}'>5/8</span>
                            </div>
                        </div>
                        <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                            <h4 class="card-title mb-4">Donut 2</h4>
                            <div class=""><span class="donut"
                                    data-peity='{ "fill": ["rgb(7, 135, 234)", "rgba(7, 135, 234, .5)"]}'>250/650</span>
                            </div>
                        </div>
                        <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                            <h4 class="card-title mb-4">Donut 3</h4>
                            <div class=""><span class="donut"
                                    data-peity='{ "fill": ["rgb(0, 171, 197)", "rgba(0, 171, 197, .5)"]}'>0.52/1.561</span>
                            </div>
                        </div>
                        <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                            <h4 class="card-title mb-4">Donut 4</h4>
                            <div class=""><span class="donut"
                                    data-peity='{ "fill": ["rgb(7, 135, 234)", "rgba(7, 135, 234, .5)"]}'>1,4</span>
                            </div>
                        </div>
                        <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                            <h4 class="card-title mb-4">Donut 5</h4>
                            <div class=""><span class="donut"
                                    data-peity='{ "fill": ["rgb(0, 0, 128)", "rgba(0, 0, 128, .5)"]}'>226,134</span>
                            </div>
                        </div>
                        <div class="col-xl-2 col-sm-4 col-6 mt-4 mt-md-0">
                            <h4 class="card-title mb-4">Donut 6</h4>
                            <div class=""><span class="donut"
                                    data-peity='{ "fill": ["rgb(117, 180, 50)", "rgba(117, 180, 50, .5)"]}'>0.52,1.041</span>
                            </div>
                        </div>
                    </div>
                </div>
