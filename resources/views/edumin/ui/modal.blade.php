                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p>This <a href="javascript:void(0);" role="button" data-container="body"
                                                data-bs-toggle="popover" class="btn btn-secondary btn-sm popover-test"
                                                title="Popover title"
                                        ...
                                        <p><a href="javascript:void(0);" class="tooltip-test text-primary"
                                                data-bs-toggle="tooltip" title="Told you!">This link</a> and <a
                                                href="javascript:void(0);" class="tooltip-test text-primary"
                                                data-bs-toggle="tooltip" title="Another one!">that link</a> have
                                            tooltips on hover.</p>
