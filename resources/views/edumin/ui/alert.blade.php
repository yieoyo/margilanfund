            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-primary alert-dismissible fade show">
                        ...
                        <strong>WOW! Eveything looks OK.</strong> <a href="javascript:void(0);">Please check this one
                            as
                            well</a>
                    </div>
                    ...
                    <div class="alert alert-warning alert-dismissible fade show">
                        ...
                        <strong>Warning!</strong> Why you did it to me! <a href="javascript:void(0);">Check this
                            out</a>
                    </div>
                    <div class="alert alert-danger alert-dismissible fade show">
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close">
                        </button>
                        <strong>Error!</strong> Something Went wrong <a href="javascript:void(0);">Click here for
                            details.</a>
                    </div>
                    <div class="alert alert-dark alert-dismissible fade show">
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close">
