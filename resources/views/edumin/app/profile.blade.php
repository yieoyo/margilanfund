                                            ...
                                            <form>
                                                ...
                                                <ul class="user-media-list">
                                                    <li class="mb-2 border-bottom pb-2">
                                                        <div class="d-flex align-items-center">
                                                            <div class="img_cont me-2">
                                                                <img src="{{ asset('images/avatar/1.jpg') }}" height="45"
                                                                    width="45" class="rounded-circle user_img"
                                                                    alt="">
                                                            </div>
                                                            <div class="user_info">
                                                    ...
                                                    <li class="mb-2 border-bottom pb-2">
                                                        <div class="d-flex align-items-center">
                                                            <div class="img_cont me-2">
                                                                <img src="{{ asset('images/avatar/2.jpg') }}" height="45"
                                                                    width="45" class="rounded-circle user_img"
                                                                    alt="">
                                                            </div>
                                                            <div class="user_info">
                                                    ...
                                                    <li class="mb-2 pb-2">
                                                        <div class="d-flex align-items-center">
                                                            <div class="img_cont me-2">
                                                                <img src="{{ asset('images/avatar/5.jpg') }}" height="45"
                                                                    width="45" class="rounded-circle user_img"
                                                                    alt="">
                                                            </div>
                                                            <div class="user_info">
                                                ...
                                                <input type="submit" value="Create"
                                                    class="submit btn btn-primary w-100" name="submit">
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <form>
                                                ...
                                                <ul class="user-media-list">
                                                    ...
                                                    <li class="mb-2 border-bottom pb-2">
                                                        <div class="d-flex align-items-center">
                                                            <div class="img_cont me-2">
                                                                <img src="{{ asset('images/avatar/3.jpg') }}" height="45"
                                                                    width="45" class="rounded-circle user_img"
                                                                    alt="">
                                                            </div>
                                                            <div class="user_info">
                                                    ...
                                                    <li class="mb-2 border-bottom pb-2">
                                                        <div class="d-flex align-items-center">
                                                            <div class="img_cont me-2">
                                                                <img src="{{ asset('images/avatar/4.jpg') }}" height="45"
                                                                    width="45" class="rounded-circle user_img"
                                                                    alt="">
                                                            </div>
                                                            <div class="user_info">
                                            ...
                                            <div class="modal-body">
                                                <form class="comment-form">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label class="form-label form-label">Name <span
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label class="form-label form-label">Email <span
                                                                        class="required">*</span></label>
                                                                <input type="text" class="form-control"
                        ...
                        <div class="card-body">
                            <div class="profile-blog">
                                ...
                                <img src="{{ asset('images/profile/1.jpg') }}" alt=""
                                    class="img-fluid mt-4 mb-4 rounded w-100">
                            ...
                            <div class="profile-news">
                                ...
                                <div class="media pt-3 pb-3">
                                    ...
                                    <div class="media-body">
                                        <h5><a href="{{ url('post-details') }}" class="text-dark">Transform Yourself, Conquer
                                                Limits.</a></h5>
                                        <p class="mb-0 line-para-height fs-15">I shared this on my twitter wall a few
                                            months back, and I thought.</p>
                                    </div>
                                </div>
                                <div class="media pt-3 pb-3">
                                    <img src="{{ asset('images/profile/6.jpg') }}" alt="image" class="me-3 rounded"
                                        width="75">
                                    <div class="media-body">
                                        <h5><a href="{{ url('post-details') }}" class="text-dark">Medical advancements
                                                globally.</a></h5>
                                        <p class="mb-0 line-para-height fs-15">I shared this on my fb wall a few months
                                            back, and I thought.</p>
                                    </div>
                                </div>
                                <div class="media pt-3 pb-0">
                                    <img src="{{ asset('images/profile/7.jpg') }}" alt="image" class="me-3 rounded"
                                        width="75">
                                    <div class="media-body">
                                        <h5><a href="{{ url('post-details') }}" class="text-dark">Collection of textile
                                                samples</a></h5>
                                        <p class="mb-0 line-para-height fs-15">I shared this on my insta wall a few
                                            months back, and I thought.</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="my-post-content pt-3">
                                        ...
                                        <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                            ...
                                            <a class="post-title" href="{{ url('post-details') }}">
                                                <h3>"Embark on a Journey of Unparalleled Excellence, Where Innovation
                                                    and Elegance Converge to Shape Tomorrow's World."</h3>
                                            </a>
                                        ...
                                        <div class="profile-uoloaded-post pb-3">
                                            <img src="{{ asset('images/profile/10.jpg') }}" alt=""
                                                class="img-fluid w-100 rounded">
                                            <a class="post-title" href="{{ url('post-details') }}">
                                                <h3>"Breakthrough Study Reveals Promising New Treatment Strategy for
