                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group pass-group">
                                                <input type="password" class="form-control pass-input"
                                                    id="validationCustom03" placeholder="Choose a safe one.." required>
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form class="form-valide-with-icon needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                <label class="text-label form-label" for="dlabPassword">Password <span
                                        class="text-danger">*</span></label>
                                <div class="input-group transparent-append  validate-password">
                                    <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
                                    <input type="password" class="form-control" id="dlabPassword"
